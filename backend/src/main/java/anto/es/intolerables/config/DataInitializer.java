...
public class DataInitializer {
    ...
    @PostConstruct
    public void init() {
        if (intoleranciaRepository.count() == 0) {
            intoleranciaRepository.save(new Intolerancia(1, "Intolerancia a la fructosa", 
            ...
            intoleranciaRepository.save(new Intolerancia(2, "Alergia a los frutos secos", 
            ...
            intoleranciaRepository.save(new Intolerancia(3, "Intolerancia al gluten", 
            ...
            intoleranciaRepository.save(new Intolerancia(4, "Alergia o intolerancia a los huevos", 
            ...
            intoleranciaRepository.save(new Intolerancia(5, "Intolerancia a la lactosa", 
            ...
            intoleranciaRepository.save(new Intolerancia(6, "Alergia a los mariscos", 
            ...
            intoleranciaRepository.save(new Intolerancia(7, "Intolerancia o alergia a la soja", 
            ...
            intoleranciaRepository.save(new Intolerancia(8, "Dieta vegana", 
